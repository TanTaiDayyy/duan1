            ...
            <form action="" class="update-status-form">
                ...
                <ul class=" prod_item ">
                    ...
                    <li class="products">
                        <ul>
                            <?php
                            $listSP = runSQL("SELECT hoa_don_chi_tiet.don_gia, hoa_don_chi_tiet.so_luong, hoa_don_chi_tiet.ma_hh, hang_hoa.ten_hh, hang_hoa.giam_gia FROM hoa_don_chi_tiet JOIN hang_hoa on hoa_don_chi_tiet.ma_hh = hang_hoa.ma_hh WHERE ma_hd=" . $ma_hd);
                            foreach ($listSP as $x) : ?>
                                <li>
